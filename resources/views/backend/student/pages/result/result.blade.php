@extends('backend.student.layouts.master')
    ...
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item">Home / student</li>
          <li class="breadcrumb-item"><a href="#">Result</a></li>
        </ul>
    </div>
    @include('backend.student.partials._message')
        ...
        <div class="clearix"></div>
            <div class="col-md-10">
                <div class="tile">
                    ...
                    <h3 class="tile-title border-bottom p-2">Search my Result</h3>
                    <div class="tile-body">
                    <div class="row">
...
function hide(){
    ...
    $('#examType').change(function (e) {
        ...
        console.log(sectionId,classId,sessionYearId,examType,examTypeName);
                $.ajax({
                    type: "POST",
                    url: "{{ url('/student/result/list')}}",
                    data: {
                    sectionId:sectionId,
                    // studentId:studentId,
                    sessionYearId:sessionYearId,
