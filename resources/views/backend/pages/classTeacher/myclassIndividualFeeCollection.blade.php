...
<div class="row justify-content-md-center">
        ...
        <div class="tile">
            {{-- need to add field for input --}}
                <div class="tile-body" id="tblHidden" hidden>
                    <form action="{{route('myclass.storeMonthly')}}" method="post" id="myform" name="form" >
        ...
        function checkedAtlestOne(){
            $("#myform").submit(function () {
                ...
                if(idChecked.length>0){
                    ...
                    roll= false;
                    alert('For Take Fee! check At least One Month');
    ...
    $('document').ready(function () {
       ...
       // var shift= {{$shift}};
        ...
        console.log(classId,sessionYearId,sectionId);
                    ...
                    $("#totalCharge2").attr('value', totalCharge);
                        ...
                        if(data.yearlypayment){
                            ...
                            if(data.month.length!=0){
                                ...
                                alert('This Fee is Already Taken For This Session Year');
                                    if(confirm){
                                        window.location.assign("/myclass/feecollection/individual")
                                    }
                                }
                        }
                }
