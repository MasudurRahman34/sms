            ...
            <div class="tile">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control changeclass" id="sectionId">
                            <option value=""> --Please Select--  </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-2 pr-2" >
                        ...
                        <select class="form-control changeclass" id="month">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control changeclass" id="studentId">
                            <option value=""> --Please Select--  </option>
                        </select>
                    </div>
                    </div>
...
<div class="row justify-content-md-center" id="print_div">
    <div class="col-md-9 ">
       <div class="tile">
            ...
            <br>
            <h5 id="unPaidDate" class=" row justify-content-md-center">Unpaid Fee List</h5>
            ...
            <br>
           <h5 class=" row justify-content-md-center">Paied Fee List</h5>
             <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                    <thead>
                        <tr>
    ...
    $('#sectionId').change(function (e) {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            var option="<option>--Please Select--</option>";
            data.forEach(element => {
                option+=("<option value='"+element.id+"'>"+element.firstName+' '+element.lastName+'(Roll: '+element.roll+')'+"</option>");
                });
...
$('#studentId').change(function (e) {
    ...
    $.ajax({
        type: "get",
        url: "{{url('payment/details/show')}}"+"/"+month+"/"+studentId+"/"+sessionYearId+"/"+classId,
