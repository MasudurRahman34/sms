@extends('backend.layouts.master')
	@section('title', 'Class Based Income Report')
    @section('content')
    <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>Class Based Income Report </h1>
          <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Income Report</a></li>
        </ul>
    </div>
...
<div class="tile mb-4">
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="bs-component">
          <div class="list-group">
            <h4 class="text-center text-info">Class Based Income Report</h4><hr class="new3" align="center" width="30%">
            <p class="text-center">Year: 2020, Class: Nine</p>
            <p class="text-center"><i class="fa fa-money" aria-hidden="true"></i>
              Total Paid: 65654745 Tk | Total Due: 55457 Tk | Total: 55675775 Tk</p>
          </div>
        </div>
        <br>
        <div class="col-md-12">
